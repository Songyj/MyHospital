...
public class CheckacceptFragment extends DialogFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.check_accept, container,false);
        ap_type = (TextView)getActivity().findViewById(R.id.Apply_Type);
        ...
        ap_type_1 = (TextView)view.findViewById(R.id.Apply_Type);
        ...
        ap_type_1.setText(ap_type.getText().toString());
